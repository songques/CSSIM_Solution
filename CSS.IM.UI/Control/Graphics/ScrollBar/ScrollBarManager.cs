...
namespace CSS.IM.UI.Control.Graphics.ScrollBar
{
    ...
    internal class ScrollBarManager : NativeWindow, IDisposable
    {
        ...
        private System.Windows.Forms.ScrollBar _owner;
        ...
        internal ScrollBarManager(System.Windows.Forms.ScrollBar owner)
            : base()
        {
            _owner = owner;
            CreateHandle();
        ...
        {
            System.Windows.Forms.ScrollBar scrollBar = _owner;
            int width;
