...
namespace CSS.IM.UI.Control.ListViewEx
{
    ...
    public class ListViewEx : ListView
    {
        ...
        private Color _rowBackColor2 = Color.White;
        ...
        private CSS.IM.UI.Control.Graphics.Win32.Struct.RECT AbsoluteClientRECT
        {
            get
            {
            ...
            LinearGradientMode mode)
        {
               ...
               rect, Color.Transparent, Color.Transparent, mode))
            {
                ...
                Color cs=Color.FromArgb(26, 115, 205);
                colors[0] = GetColor(cs, 0, 68, 69, 54);
                colors[1] = GetColor(cs, 0, 68, 69, 54);
                colors[2] = GetColor(cs, 0, 68, 69, 54);
                colors[3] = GetColor(cs, 0, 68, 69, 54);
