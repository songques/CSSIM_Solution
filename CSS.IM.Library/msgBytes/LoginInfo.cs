...
namespace CSS.IM.Library.Class 
{
    ...
    public class LoginInfo
    {
        ...
        public string userPassword 
        {
            ...
            get { return CSS.IM.Library.Class.TextEncoder.bytesToText(this._userPassword).Trim('\0'); }
        }
        #endregion
        ...
        public string softwareVersion
        {
            set
            {
                byte[] buf = CSS.IM.Library.Class.TextEncoder.textToBytes(CSS.IM.Library.Class.Hasher.GetMD5Hash(CSS.IM.Library.Class.TextEncoder.textToBytes(value)));
            ...
            get { return CSS.IM.Library.Class.TextEncoder.bytesToText(this._softwareVersion).Trim('\0'); }
        }
        #endregion
        ...
        public System.Net.IPAddress userLocalIP
        {
            set
            {
                this._userLocalIP = CSS.IM.Library.Class.IP.IPAddressToBytes(value); //将IP转换成32位整型
            }
            get
            {
                return CSS.IM.Library.Class.IP.BytesToIPAddress(this._userLocalIP);//将int转换成IP地址
            }
        }
        #endregion
