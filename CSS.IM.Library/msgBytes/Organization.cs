    ...
    public class Organization
    {
       ...
       #region 设置或获取组织机构版本 MD5
        ...
        public string DepVersion
        {
            ...
            get { return CSS.IM.Library.Class.TextEncoder.bytesToText(this._depVersion).Trim('\0'); }
        }
        #endregion
       ...
       #region 设置或获取用户版本 MD5
        ...
        public string UserVersion
        {
            ...
            get { return CSS.IM.Library.Class.TextEncoder.bytesToText(this._UserVersion).Trim('\0'); }
        }
        #endregion
       ...
       #region 设置或获取用户最后一次登录IP
        ...
        public System.Net.IPAddress LastLoginIP
        {
            set
            {
                this._lastLoginIP = CSS.IM.Library.Class.IP.IPAddressToBytes(value);  //将IP转换成32位整型
            }
            get
            {
                return CSS.IM.Library.Class.IP.BytesToIPAddress(this._lastLoginIP);//将int转换成IP地址
            }
        }
        #endregion
       ...
       #region 设置或获取用户最后一次登录时间
        ...
        public string  LastLoginDate
        {
            ...
            get { return CSS.IM.Library.Class.TextEncoder.bytesToText(this._lastLoginDate).Trim('\0'); }
        }
       #endregion
       ...
       #region 设置或获取用户网络硬盘的URI
        ...
        public string  HardDiskURI
        {
            ...
            get { return CSS.IM.Library.Class.TextEncoder.bytesToText(this._HardDiskURI).Trim('\0'); }
        }
        #endregion
       ...
       #region 设置或获取用户网络硬盘的用户名
        ...
        public string HardDiskUserName
        {
            ...
            get { return CSS.IM.Library.Class.TextEncoder.bytesToText(this._HardDiskUserName).Trim('\0'); }
        }
        #endregion
       ...
       #region 设置或获取用户网络硬盘的用户密码
        ...
        public string HardDiskPassword
        {
            ...
            get { return CSS.IM.Library.Class.TextEncoder.bytesToText(this._HardDiskPassword).Trim('\0'); }
        }
        #endregion
       ...
       #region 设置或获取用户网络硬盘的网络域名
        ...
        public string HardDiskDomain
        {
            ...
            get { return CSS.IM.Library.Class.TextEncoder.bytesToText(this._HardDiskDomain).Trim('\0'); }
        }
        #endregion
