    ...
    public class Msg 
    {
        ...
        public string Password
        {
            ...
            get
            {
                ...
                return CSS.IM.Library.Class.TextEncoder.bytesToText(buf).Trim('\0');
            }
        }
        #endregion
        ...
        public string SendID
        {
            set
            {
                this.sendID = CSS.IM.Library.Class.TextEncoder.textToBytes(value.ToString());
            ...
            get
            {
                ...
                return CSS.IM.Library.Class.TextEncoder.bytesToText(buf);
            }
        }
        #endregion
        ...
        public string ReceiveID
        {
            set
            {
                this.receiveID = CSS.IM.Library.Class.TextEncoder.textToBytes(value.ToString());
        ...
        public Msg(byte InfoClass, string  MsgContent, string  MsgImageInfo,System.Drawing.Font msgFont, System.Drawing.Color msgTextColor, string msgReceiveID,  int msgReceiveIndex)
        {
            ...
            this.Content = CSS.IM.Library.Class.TextEncoder.textToBytes(MsgContent);
            this.ImageInfo = CSS.IM.Library.Class.TextEncoder.textToBytes(MsgImageInfo);
