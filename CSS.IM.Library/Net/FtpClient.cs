...
namespace CSS.IM.Library.Net
{
    ...
    public class FTPClient
    {
        ...
        public delegate void PushProgressDelegate(FTPClient sender, int args);
        ...
        /// <param name="sender"></param>
        /// <param name="args"></param>
        public delegate void PushFileSucceedDelegate(FTPClient sender, string args);
        ...
        /// <param name="sender"></param>
        /// <param name="args"></param>
        public delegate void PushFilesSucceedDelegate(FTPClient sender, string args);
        ...
        /// <param name="sender"></param>
        /// <param name="args"></param>
        public delegate void PushFileErrorDelegate(FTPClient sender, bool args);
        ...
        /// <param name="sender"></param>
        /// <param name="args"></param>
        public delegate void GetFileProgressDelegate(FTPClient sender, int args);
        ...
        /// <param name="sender"></param>
        /// <param name="args"></param>
        public delegate void GetFileSucceedDelegate(FTPClient sender, string args);
        ...
        /// <param name="sender"></param>
        /// <param name="args"></param>
        public delegate void GetFileErrorDelegate(FTPClient sender, bool args);
        ...
        /// 接收和发送数据的缓冲区
        /// </summary>
        private static int BLOCK_SIZE = 1024*50;
        ...
        public SendFileManager sendFileManager { set; get; }

        public FileTransfersItem fileTransfersItem { set; get; }
        /// <summary>
        /// 用于处理socket连接超时问题
        /// </summary>
        ...
        public void GetFile(string strRemoteFileName, string strFolder, string strLocalFileName)
        {
            ...
            {
                //string[] infos = strRemoteFileName.Split(' ');
                //strRemoteFileName = infos[infos.Length - 1];
            ...
            aa:
                ...
                if (!File.Exists(strFolder + "\\" + strLocalFileName))
                {
                    try
                    {
                        if (fileTransfersItem != null)
                        {
                            fileTransfersItem.receivePath = strFolder;
                            fileTransfersItem.FileName = strLocalFileName;
                        }
                ...
                else
                {
                    ...
                    if (lname == null)
                    {
                        lname = strLocalFileName.Substring(strLocalFileName.LastIndexOf("."), strLocalFileName.Length - strLocalFileName.LastIndexOf("."));
                    }

                    if (sname == null)
                    {
                        sname = strLocalFileName.Substring(0, strLocalFileName.LastIndexOf("."));
                    }
                    strLocalFileName = sname + "_" + (bakindex++) + lname;
                    goto aa;
                }
                ...
                while (IsLive)
                {
                    ...
                    {
                        //int iBytes = socketData.Receive(buffer, buffer.Length, 0);
                        int iBytes = socketData.Receive(buffer,buffer.Length,SocketFlags.None);
                        output.Write(buffer, 0, iBytes);
                        if (GetFileProgressEvent != null)
                        {
                            GetFileProgressEvent(this, iBytes);
                        }
                        if (iBytes <= 0)
                        {
                            break;
                ...
                {
                    GetFileSucceedEvent(this, strRemoteFileName);
                }
            }
        }
        ...
        public void GetFile(string strRemoteFileName, string strFolder)
        {
            ...
            if (strLocalFileName != null)
            {
                ...
                if (!File.Exists(strLocalFileName))
                {
                    try
                    {
                        Stream st = File.Create(strFolder + "\\" + strLocalFileName + ".gif");
                        st.Close();
                    }
                    catch (Exception error)
                    {
                ...
                try
                {
                    output = new FileStream(strFolder + "\\" + strLocalFileName + ".gif", FileMode.Create);
                }
                catch (Exception error)
                {
                    if (GetFileErrorEvent != null)
        ...
        public void Put(string strFileName, bool isActive)
        {
            ...
            if (!bConnected)
            {
                ...
                catch (Exception error)
                {
                    ...
                    {
                        PushFileErrorEvent(this, Cancel);
                    }
                    CloseSocketConnect();
                    throw error;
                }
            ...
            try
            {
                input = new FileStream(strFileName,FileMode.Open,FileAccess.Read,FileShare.Read);
            }
            catch (Exception error)
            {
                if (input!=null)
            ...
            if (isActive)
            {
                if (IsLive)
                {
                    ...
                    {
                        PushFileSucceedEvent(this, ftpname);
                    }
                }
            }
        ...
        /// </summary>
        /// <param name="strFileName">本地文件名</param>
        /// /// <param name="remoteName">远程文件名称</param>
        /// <param name="isFrist">上传完成是否激活事件</param>
        public void Put(string strFileName,string remoteName,bool isActive)
        {
            string ftpname = remoteName;
            if (!bConnected)
            {
                try
                {
