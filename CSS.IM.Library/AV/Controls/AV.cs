...
namespace CSS.IM.Library.AV.Controls
{
    ...
    /// AV组件
    /// </summary>
    public partial class AV : Component
    {
        /// <summary>
        /// 构造
        /// </summary>
        ...
        public AV(IContainer container)
        {
            container.Add(this);
        ...
        #region 通信事件
        private void aVcommunication1_AVConnected(object sender, CSS.IM.Library.Class.NetCommunicationClass netCommuctionClass)
        {
