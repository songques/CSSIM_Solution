...
namespace CSS.IM.Library.AV
{
    public partial class AVcommunication : Component
    {
        ...
        private CSS.IM.Library.Class.NetCommunicationClass netClass = CSS.IM.Library.Class.NetCommunicationClass.None;//标识没有建立通信
        private bool UdpHandshakeInfoClass = false;//UDP握手有两种可能，第一种为局域网，记为false，第二种为广域网，记为true;

        private CSS.IM.Library.Class.UserInfo _OppositeUserInfo;//对方用户在线信息
        private CSS.IM.Library.Class.UserInfo _selfUserInfo;//自己的用户在线信息
        ...
        public void SetParameter(System.Net.IPAddress ServerIP, int ServerUDPPort, int ServerTCPPort, CSS.IM.Library.Class.UserInfo selfUserInfo, CSS.IM.Library.Class.UserInfo OppositeUserInfo)
        {
            //音视频传输前建立双方连接的参数设置函数
        ...
        private void OnGetBITMAPINFOHEADER(byte[] data)//
        {
            ...
            CSS.IM.Library.Class.BitmapInfoHeader bit = new CSS.IM.Library.Class.BitmapInfoHeader(data);
