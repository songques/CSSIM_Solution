...
namespace CSS.IM.Library.Controls.UdpSendFile
{
    ...
    public class SendFileManager : IDisposable
    {
        ...
        private int _partSize = 1024 * 40;
        private string _fileName;
        private string _md5;
        private object _tag;
        private Stream _safeStream;
        public CSS.IM.Library.Net.FTPClient ftpClient { set;get;}

        /// <summary>
        /// 发送文件超时
        /// </summary>
        public int SendFileOutTime { set;get;}
        ...
        public SendFileManager(string fileName,bool online)
        {
            _fileName = fileName;
            Create(fileName,online);
        }
        ...
        private void Create(string fileName,bool onlie)
        {
            ...
            _md5 = MD5Helper.CretaeMD5(fileName);
