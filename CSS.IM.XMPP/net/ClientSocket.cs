...
using CSS.IM.XMPP.IO.Compression;
        ...
        public override void Connect()
		{
            ...
            try
            {
                ...
                for (int i = 0; i < ipHostInfo.AddressList.Length; i++)
                {
                    ...
                    { 
                       ipAddress = ipHostInfo.AddressList[i];// IPAddress.Parse(address);
                    }
                }
                /********************************************************************/
...
#endif*/
                _socket = new Socket(AddressFamily.InterNetwork, SocketType.Stream, ProtocolType.Tcp);//新添加
        ...
        private void EndConnect(IAsyncResult ar)
        {
            ...
            else
            {
                ...
                { 
                    ...
                    LocalHostIP = ((IPEndPoint)_socket.LocalEndPoint).Address.ToString();
