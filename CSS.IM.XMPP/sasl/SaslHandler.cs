...
namespace CSS.IM.XMPP.sasl
{
	...
	{		
		...
		private CSS.IM.XMPP.sasl.Mechanism	m_Mechanism		= null;
		...
		internal void OnStreamElement(object sender, CSS.IM.XMPP.Xml.Dom.Node e)
		{
					...
					{	
						...
						if (f.Mechanisms!=null)
						{
                                ...
                                && f.Mechanisms.SupportsMechanism(MechanismType.X_GOOGLE_TOKEN) )
                            {
                                ...
                                args.Mechanism = CSS.IM.XMPP.protocol.sasl.Mechanism.GetMechanismName(MechanismType.X_GOOGLE_TOKEN);
                            }
							else if (f.Mechanisms.SupportsMechanism(MechanismType.DIGEST_MD5))
							{
								args.Mechanism = CSS.IM.XMPP.protocol.sasl.Mechanism.GetMechanismName(MechanismType.DIGEST_MD5);
							}
							else if (f.Mechanisms.SupportsMechanism(MechanismType.PLAIN))							
							{
								args.Mechanism = CSS.IM.XMPP.protocol.sasl.Mechanism.GetMechanismName(MechanismType.PLAIN);
							}
							else
							{								
								args.Mechanism = null;
						...
						else
						{
							...
							args.Mechanism = null;
							//args.Mechanism = CSS.IM.XMPP.protocol.sasl.Mechanism.GetMechanismName(CSS.IM.XMPP.protocol.sasl.MechanismType.PLAIN);
						}
					}
