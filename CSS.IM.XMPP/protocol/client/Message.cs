...
using CSS.IM.XMPP.protocol.extensions.html;
using CSS.IM.XMPP.protocol.extensions.chatstates;
using CSS.IM.XMPP.protocol.extensions.nickname;
using CSS.IM.XMPP.protocol.extensions.shim;
