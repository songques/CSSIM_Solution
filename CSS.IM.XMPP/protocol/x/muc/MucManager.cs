...
using CSS.IM.XMPP.protocol.x.muc.iq;
using CSS.IM.XMPP.protocol.x.muc.iq.admin;
using CSS.IM.XMPP.protocol.x.muc.iq.owner;

using CSS.IM.XMPP.protocol.x.data;

namespace CSS.IM.XMPP.protocol.x.muc
{
    /// <summary>
    ...
    public class MucManager
    {
        ...
        */
        ...
        {
            OwnerIq oIq = new CSS.IM.XMPP.protocol.x.muc.iq.owner.OwnerIq(IqType.set, room);
            oIq.Query.AddChild(new Data(XDataFormType.submit));
            
            if (cb == null)
                m_connection.Send(oIq);
            else
                m_connection.IqGrabber.SendIq(oIq, cb, cbArgs,true);
        }
        ...
        {
            OwnerIq oIq = new CSS.IM.XMPP.protocol.x.muc.iq.owner.OwnerIq(IqType.get, room);          
        ...
        */
        ...
        public void RequestList(Affiliation affiliation, Jid room, IqCB cb, object cbArg)
        {
            ...
            aIq.Query.AddItem(new CSS.IM.XMPP.protocol.x.muc.iq.admin.Item(affiliation));
        ...
        public void CreateReservedRoom(Jid room, IqCB cb, object cbArg)
        {
            ...
            */
            ...
            if (cb == null)
                ...
                m_connection.IqGrabber.SendIq(iq, cb, cbArg,true);
        }
        #endregion       
        ...
        public void ModifyList(Jid room, CSS.IM.XMPP.protocol.x.muc.iq.admin.Item[] items)
        {
            ModifyList(room, items, null, null);
        }

        public void ModifyList(Jid room, CSS.IM.XMPP.protocol.x.muc.iq.admin.Item[] items, IqCB cb)
        {
