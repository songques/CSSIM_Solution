...
namespace CSS.IM.XMPP.protocol.component
{
    ...
    /// </summary>
    public class Message : CSS.IM.XMPP.protocol.client.Message
    {
        #region << Constructors >>
        public Message()
            : base()
        ...
        public Message(string to, CSS.IM.XMPP.protocol.client.MessageType type, string body)
            : base(to, type, body)
        {
            this.Namespace = Uri.ACCEPT;
        }

        public Message(Jid to, CSS.IM.XMPP.protocol.client.MessageType type, string body)
            : base(to, type, body)
        {
            this.Namespace = Uri.ACCEPT;
        }

        public Message(string to, CSS.IM.XMPP.protocol.client.MessageType type, string body, string subject)
            : base(to, type, body, subject)
        {
            this.Namespace = Uri.ACCEPT;
        }

        public Message(Jid to, CSS.IM.XMPP.protocol.client.MessageType type, string body, string subject)
            : base(to, type, body, subject)
        {
            this.Namespace = Uri.ACCEPT;
        }

        public Message(string to, CSS.IM.XMPP.protocol.client.MessageType type, string body, string subject, string thread)
            : base(to, type, body, subject, thread)
        {
            this.Namespace = Uri.ACCEPT;
        }

        public Message(Jid to, CSS.IM.XMPP.protocol.client.MessageType type, string body, string subject, string thread)
            : base(to, type, body, subject, thread)
        {
            this.Namespace = Uri.ACCEPT;
        }
        ...
        public Message(Jid to, Jid from, CSS.IM.XMPP.protocol.client.MessageType type, string body)
            : base(to, from, type, body)
        {
            this.Namespace = Uri.ACCEPT;
        }

        public Message(Jid to, Jid from, CSS.IM.XMPP.protocol.client.MessageType type, string body, string subject)
            : base(to, from, type, body, subject)
        {
            this.Namespace = Uri.ACCEPT;
        }

        public Message(Jid to, Jid from, CSS.IM.XMPP.protocol.client.MessageType type, string body, string subject, string thread)
