...
using CSS.IM.XMPP.protocol.iq.privacy;

namespace CSS.IM.XMPP.protocol.iq.privacy
{
    /// <summary>
    ...
    public class RuleManager
    {
        ...
        {
            return new Item(Action.deny, Order, CSS.IM.XMPP.protocol.iq.privacy.Type.jid, JidToBlock.ToString(), stanza);
        }
        ...
        {
            return new Item(Action.deny, Order, CSS.IM.XMPP.protocol.iq.privacy.Type.subscription, subType.ToString(), stanza);
        }
        ...
        {
            return new Item(Action.allow, Order, CSS.IM.XMPP.protocol.iq.privacy.Type.group, group, stanza);
        }
