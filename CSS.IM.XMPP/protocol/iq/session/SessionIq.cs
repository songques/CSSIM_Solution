...
namespace CSS.IM.XMPP.protocol.iq.session
{
	/// <summary>
	...
	{
		/*
		SEND:	<iq xmlns="jabber:client" id="CSS.IM.XMPP_2" type="set" to="jabber.ru">
					<session xmlns="urn:ietf:params:xml:ns:xmpp-session" />
				</iq>
		RECV:	<iq xmlns="jabber:client" from="jabber.ru" type="result" id="CSS.IM.XMPP_2">
					<session xmlns="urn:ietf:params:xml:ns:xmpp-session" />
				</iq> 
		 */
