...
using CSS.IM.XMPP.protocol.extensions.bosh;
...
namespace CSS.IM.XMPP
{
	...
	{	
		...
		public XmppConnection(CSS.IM.XMPP.net.SocketConnectionType type) : this()
		{
		...
		private void InitSocket()
		{
			...
			// Socket Stuff
			if (m_SocketConnectionType == CSS.IM.XMPP.net.SocketConnectionType.HttpPolling)
				m_ClientSocket= new PollClientSocket();
            else if (m_SocketConnectionType == CSS.IM.XMPP.net.SocketConnectionType.Bosh)
                m_ClientSocket = new BoshClientSocket(this);
            else
            {
                m_ClientSocket = new ClientSocket();
                m_ClientSocket.StartCompression();
            }
