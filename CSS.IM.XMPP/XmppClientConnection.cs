...
using CSS.IM.XMPP.protocol.iq.auth;
using CSS.IM.XMPP.protocol.iq.agent;
using CSS.IM.XMPP.protocol.iq.disco;
using CSS.IM.XMPP.protocol.iq.roster;
using CSS.IM.XMPP.protocol.iq.register;
using CSS.IM.XMPP.protocol.iq.version;
using CSS.IM.XMPP.protocol.stream;
using CSS.IM.XMPP.protocol.stream.feature.compression;
using CSS.IM.XMPP.protocol.client;
using CSS.IM.XMPP.protocol.tls;

using CSS.IM.XMPP.protocol.extensions.caps;
using CSS.IM.XMPP.protocol.extensions.compression;

using CSS.IM.XMPP.exceptions;

using CSS.IM.XMPP.sasl;
using CSS.IM.XMPP.net;
using CSS.IM.XMPP.net.dns;


using CSS.IM.XMPP.Idn;

#if MONOSSL
using  Mono.Security.Protocol.Tls;
#endif

namespace CSS.IM.XMPP
{
	...
	{       
		...
		private		string					m_Resource			= "CSS.IM.XMPP";		
        ...
        /// </summary>
        /// <seealso cref="CSS.IM.XMPP.protocol.Base.XmppPacket.Language"/>
		...
		*/
		...
		{			
			...
			{
				/* 
				 * <iq xmlns="jabber:client" id="CSS.IM.XMPP_2" type="error">
        ...
        public override void Send(Element e)
        {
            if (!(ClientSocket is BoshClientSocket))
            {
                ...
                string msgxml = toSend.Substring(25, toSend.Length - 25 - 4);
        ...
        internal void RaiseOnLogin(IQ iq)
		{
            if (KeepAlive)
                CreateKeepAliveTimer();
