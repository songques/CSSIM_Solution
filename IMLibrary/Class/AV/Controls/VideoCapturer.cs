...
namespace IMLibrary.AV.Controls
{
    ...
    public class VideoCapturer
    {
      ...
      /// <param name="e"></param>
        public delegate void VideoDataCaptureredEventHandler(object sender, VideoCapturedEventArgs e);
       
        /// <summary>
        /// 捕获到视频数据事件
        /// </summary>
        public event VideoDataCaptureredEventHandler VideoDataCapturered;
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        public delegate void VideoCapturerBeforeEventHandler(object sender, VideoCapturedEventArgs e);

        /// <summary>
        /// 视频捕获前事件
        /// </summary>
        public event VideoCapturerBeforeEventHandler VideoCapturerBefore;
        ...
        private  void StartVideoCapture()
        {
            ...
            //IMLibrary.Class.Calculate.WirteLog("biSize:" + bitmapInfo.bmiHeader.biSize.ToString() + " biSizeImage:" + bitmapInfo.bmiHeader.biSizeImage.ToString()
