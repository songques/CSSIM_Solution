...
namespace IMLibrary.Class 
{
    ...
    public  class GroupInfo
    {
        ...
        public string GroupName
        {
            ...
            get { return IMLibrary.Class.TextEncoder.bytesToText(this.groupName).Trim('\0'); }
        }
        #endregion
        ...
        public string CreateUserID
        {
            ...
            get { return IMLibrary.Class.TextEncoder.bytesToText(this.createUserID).Trim('\0'); }
        }
        #endregion
        ...
        public string Notice
        {
            ...
            get { return IMLibrary.Class.TextEncoder.bytesToText(this.notice).Trim('\0'); }
        }
        #endregion
