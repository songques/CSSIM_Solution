...
namespace IMLibrary.Class 
{
    ...
    public class ChangePassword
    {
        ...
        public string NewPassword
        {
            ...
            get { return IMLibrary.Class.TextEncoder.bytesToText(this._userNewPassword).Trim('\0'); }
        }
        #endregion
        ...
        public string OldPassword
        {
            ...
            get { return IMLibrary.Class.TextEncoder.bytesToText(this._userOldPassword).Trim('\0'); }
        }
        #endregion
