    ...
    public class UserData
    {
       ...
       #region 设置或获取UserName
        ...
        public string UserName
        {
            ...
            get { return IMLibrary.Class.TextEncoder.bytesToText(this._userName).Trim('\0'); }
        }
        #endregion
       ...
       #region 设置或获取job
        ...
        public string Job
        {
            ...
            get { return IMLibrary.Class.TextEncoder.bytesToText(this._job).Trim('\0'); }
        }
        #endregion
       ...
       #region 设置或获取Phone
        ...
        public string Phone
        {
            ...
            get { return IMLibrary.Class.TextEncoder.bytesToText(this._phone).Trim('\0'); }
        }
        #endregion
       ...
       #region 设置或获取Moblie
        ...
        public string Moblie
        {
            ...
            get { return IMLibrary.Class.TextEncoder.bytesToText(this._moblie).Trim('\0'); }
        }
       #endregion
       ...
       #region 设置或获取PHS
        ...
        public string PHS
        {
            ...
            get { return IMLibrary.Class.TextEncoder.bytesToText(this._phs).Trim('\0'); }
        }
        #endregion
