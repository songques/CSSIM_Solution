...
namespace IMLibrary.Net
{
    ...
    public partial class SockTCPClient : Component
    {
        ...
        private IMLibrary.Net.MyTcp _myTcp = new  IMLibrary.Net.MyTcp();
        ...
        public delegate void ErrorEventHandler(object sender, IMLibrary.Net.SockEventArgs e);
       ...
       /// <param name="sender"></param>
       /// <param name="e"></param>
        public delegate void DataArrivalEventHandler(object sender, IMLibrary.Net.SockEventArgs e);

        /// <summary>
        /// 断开连接 
        /// </summary>
        public delegate void DisconnectedEventHandler(object sender, IMLibrary.Net.SockEventArgs e);


        /// <summary>
        /// 连接建立 
        /// </summary>
        public delegate void ConnectedEventHandler(object sender, IMLibrary.Net.SockEventArgs e);

        /// <summary>
        /// 拒绝服务 
        /// </summary>
        public delegate void DisServerEventHandler(object sender, IMLibrary.Net.SockEventArgs e);
        ...
        {
            IMLibrary.Net.MyTcp myTcp = (IMLibrary.Net.MyTcp)aResult.AsyncState;
            try
            {
                if (IsStopServer == false)
                {
                    ...
                    if (iReceiveCount > 0)
                    {
                        ...
                        byte[] data =IMLibrary.Net.SealedMsg.RecvMsgBytes(myTcp.Buffer);    
                        if (OnDataArrival != null)
                            OnDataArrival(this, new IMLibrary.Net.SockEventArgs(data,myTcp.IP,myTcp.Port));
            ...
            {
                if (OnError != null)
                    OnError(this, new IMLibrary.Net.SockEventArgs(1, ex.Message));
            }
        }
        ...
        private void AsyncSend(IAsyncResult aResult)
        {
            ...
            {
                if (OnError != null)
                    OnError(this, new IMLibrary.Net.SockEventArgs(2, ex.Message));
            }
        }
        ...
        {
            Data =IMLibrary.Net.SealedMsg.SendMsgBytes(Data);    
            ...
            {
                if (OnError != null)
                    OnError(this, new IMLibrary.Net.SockEventArgs(3, ex.Message));
            }
        }
        ...
        private void target()
        {
            while (true)
            {
                ...
                if (iReceiveCount > 0)
                {
                    byte[] data = IMLibrary.Net.SealedMsg.RecvMsgBytes(_myTcp.Buffer);
                    if (OnDataArrival != null)
                        OnDataArrival(this, new IMLibrary.Net.SockEventArgs(data, RemoteIPAddress, RemotePort));
                }
                else
                {
                    Disconnect();
        ...
        public bool InitSocket(System.Net.IPAddress localIPAddress, int localPort)
        {
            ...
            catch (Exception ex)
            {
                Active = false;
                if (OnError != null)
                    OnError(this, new IMLibrary.Net.SockEventArgs(5, ex.Message));
            }
            return Active;
        }
        ...
        public bool Connect(System.Net.IPAddress remoteIPAddress, int remotePort)
        {
            ...
            {
                if (OnError != null)
                    OnError(this, new IMLibrary.Net.SockEventArgs(6, ex.Message));
            }
        ...
        public bool Disconnect( )
        {
                ...
                if (_Socket != null)
                {
                    if (_Socket.Connected)//如果已建立与服务器的连接，则断开联接
                    {
                        ...
                        if (OnDisconnected != null)
                            OnDisconnected(this, new IMLibrary.Net.SockEventArgs());//触发断开联接事件
                    }
                    _Socket.Close();
                    _Socket = null;
                }
            ...
            {
                if (OnError != null)
                    OnError(this, new IMLibrary.Net.SockEventArgs(7, ex.Message));
                return false;
            }
        }
